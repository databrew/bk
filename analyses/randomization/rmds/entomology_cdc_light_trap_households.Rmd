---
title: "Entomology CDC Light Trap Households"
output: pdf_document
header-includes:
- \usepackage{booktabs}
...
clusters <- sort(unique(cdc_light_trap_households$cluster_number))
...
for (i in 1:length(clusters)) {
  ...
  this_data <- cdc_light_trap_households %>% filter(cluster_number == this_cluster)
