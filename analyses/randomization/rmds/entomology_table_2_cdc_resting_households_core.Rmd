---
title: "CDC Resting Households Core"
output: pdf_document
geometry: margin=1cm
...
clusters <- sort(unique(cdc_resting_households_core$cluster_number))
...
for (i in 1:length(clusters)) {
  ...
  this_data <- cdc_resting_households_core %>% filter(cluster_number == this_cluster)
