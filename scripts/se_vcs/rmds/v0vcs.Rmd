...
for(i in 1:length(pgs)){
  ...
  print(k)
  cat(paste0('\n\nThis is a transitory document to assist the fieldworkers with household identification. This document will not be retained in the study investigator site file (ISF).\n\n'))
  cat(paste0('\\vfill\n\n'))
  cat(paste0(this_pg, '\n'))
  cat('\\newpage')
}
